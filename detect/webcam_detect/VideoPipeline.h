...
/*
 * 
 * gst-launch-1.0 v4l2src device="/dev/video0" ! queue ! qtivtransform ! capsfilter caps="video/x-raw,format=RGB,width=1920,height=1080" ! appsink drop=true sync=false
 * 
 */
